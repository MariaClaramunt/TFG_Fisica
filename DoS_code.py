...
for j, dcc in enumerate(dcc_vals):
    ...
    beta_plus_s, beta_minus_s = eigenvalues(ks, c1, c2)
    beta_plus_i, beta_minus_i = eigenvalues(ki, c1, c2)
...
axs[0].set_ylabel(r'$\beta$', rotation=0, fontsize=fontsize)
...
axs[0].text(-0.1, 1.1, '(a)', transform=axs[0].transAxes, fontsize=30)
...
axs[1].set_ylabel(r'$\beta$', rotation=0, fontsize=fontsize)
...
axs[1].text(-0.1, 1.1, '(b)', transform=axs[1].transAxes, fontsize=30)
...
axs[2].set_ylabel(r'$\beta$', rotation=0, fontsize=fontsize)
...
axs[2].text(-0.1, 1.1, '(c)', transform=axs[2].transAxes, fontsize=30)
